...
public class RedStorageAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.driveTrain.setPoseEstimate(CarouselAuto.RedConstants.START_POSITION);
        ...
        TrajectorySequence autoLeft = robot.driveTrain.trajectorySequenceBuilder(CarouselAuto.RedConstants.START_POSITION)
                .addTemporalMarker(()-> {
                ...
                .lineToLinearHeading(CarouselAuto.RedConstants.TEAM_SHIPPING_HUB_LEVEL_1)
                .addTemporalMarker(()-> {
                ...
                .lineToLinearHeading(CarouselAuto.RedConstants.CAROUSEL_POSITION_1)
                .addTemporalMarker(()-> {
                })
                .addTemporalMarker(()-> {
                    robot.spinMotor.setVelocity(220);
                })
                .waitSeconds(4)
                .addTemporalMarker(()-> {
                    robot.spinMotor.setVelocity(0);
                })
                .lineToLinearHeading(CarouselAuto.RedConstants.PARK)
                .strafeLeft(4)
                .build();

        TrajectorySequence autoMiddle = robot.driveTrain.trajectorySequenceBuilder(CarouselAuto.RedConstants.START_POSITION)
                .addTemporalMarker(()-> {
                    robot.intakeSys.regularFreightIntake();
                })
                .addTemporalMarker(0.5, ()-> {
                ...
                .lineToLinearHeading(CarouselAuto.RedConstants.TEAM_SHIPPING_HUB_LEVEL_2)
                .addTemporalMarker(()-> {
                    robot.lift.superDrop();
                })
                .waitSeconds(2)
        ...
        TrajectorySequence autoRight = robot.driveTrain.trajectorySequenceBuilder(CarouselAuto.RedConstants.START_POSITION)
                .addTemporalMarker(()-> {
                    robot.intakeSys.regularFreightIntake();
                })
                .addTemporalMarker(0.5, ()-> {
