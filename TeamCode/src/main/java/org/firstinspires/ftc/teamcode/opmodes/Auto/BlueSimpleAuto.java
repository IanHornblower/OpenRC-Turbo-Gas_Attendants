...
public class BlueSimpleAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.driveTrain.setPoseEstimate(PlaceParkAuto.BlueConstants.START_POSITION);
        ...
        TrajectorySequence autoLeft = robot.driveTrain.trajectorySequenceBuilder(PlaceParkAuto.BlueConstants.START_POSITION)
                .addTemporalMarker(()-> {
                ...
                .lineToLinearHeading(PlaceParkAuto.BlueConstants.TEAM_SHIPPING_HUB_LEVEL_1)
                .addTemporalMarker(()-> {
        ...
        TrajectorySequence autoMiddle = robot.driveTrain.trajectorySequenceBuilder(PlaceParkAuto.BlueConstants.START_POSITION)
                .addTemporalMarker(()-> {
                    robot.intakeSys.regularFreightIntake();
                })
                .addTemporalMarker(0.5, ()-> {
                ...
                .lineToLinearHeading(PlaceParkAuto.BlueConstants.TEAM_SHIPPING_HUB_LEVEL_2)
                .addTemporalMarker(()-> {
                    robot.lift.superDrop();
                })
                .waitSeconds(2)
        ...
        TrajectorySequence autoRight = robot.driveTrain.trajectorySequenceBuilder(PlaceParkAuto.BlueConstants.START_POSITION)
                .addTemporalMarker(()-> {
                    robot.intakeSys.regularFreightIntake();
                })
                .addTemporalMarker(0.5, ()-> {
