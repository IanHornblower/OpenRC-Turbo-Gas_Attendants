...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.26; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.89; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = (24/23.25)/(24/24.3);
    public static double Y_MULTIPLIER = 24/23.41;
