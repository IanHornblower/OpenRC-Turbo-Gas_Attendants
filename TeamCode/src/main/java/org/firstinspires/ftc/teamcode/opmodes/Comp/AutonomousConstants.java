...
public class AutonomousConstants {
    public static class RedConstants {
        public static class Warehouse {
            ...
            public static Pose2D SHIPPING_HUB_LEVEL_THREE = new Pose2D(44, -5, Math.toRadians(27));

            public static Pose2D SHIPPING_HUB_LEVEL_CYCLE_1 = new Pose2D(44, -5, Math.toRadians(15));
            public static Pose2D SHIPPING_HUB_LEVEL_CYCLE_2 = new Pose2D(44, -5, Math.toRadians(17));
            ...
            public static double PARK_DISTANCE = 39;
